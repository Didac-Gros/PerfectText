            ...
            return (
              <motion.div
                ...
                className={cn(
                  ...
                  "dark:bg-gray-800/80 dark:shadow-[2px_2px_4px_rgba(0,0,0,0.4),-1px_-1px_3px_rgba(255,255,255,0.1)]",
                )}
                style={{
              ...
              >
                {showArrows && isCurrentCard && (
                  <div className="absolute inset-x-0 top-2 flex justify-between px-4">
                    <span className="text-2xl select-none cursor-pointer text-gray-300 hover:text-gray-400 dark:text-gray-500 dark:hover:text-gray-400">
                      &larr;
                    </span>
                    <span className="text-2xl select-none cursor-pointer text-gray-300 hover:text-gray-400 dark:text-gray-500 dark:hover:text-gray-400">
                      &rarr;
