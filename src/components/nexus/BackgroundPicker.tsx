...
const defaultBackgrounds = [
  ...
  {
    type: 'image' as const,
    value: 'https://images.unsplash.com/photo-1682686580391-615b1f28e5ee?q=80&w=2070&auto=format&fit=crop'
  },
  {
    type: 'image' as const,
    value: 'https://images.unsplash.com/photo-1682686580186-b55d2a91053c?q=80&w=2075&auto=format&fit=crop'
  },
  {
...
export function BackgroundPicker({ onClose, onSelect, currentBackground }: BackgroundPickerProps) {
  const [activeTab, setActiveTab] = React.useState<'photos' | 'colors'>('photos');
  ...
  const isCurrentBackground = (background: Board['background']) => {
    ...
    return currentBackground.type === background.type && 
        ...
        >
          ...
          <div className="p-4">
            ...
            <div className="grid grid-cols-3 gap-3">
              {defaultBackgrounds
                .filter(bg => 
                  activeTab === 'photos' ? bg.type === 'image' : bg.type === 'gradient'
                )
