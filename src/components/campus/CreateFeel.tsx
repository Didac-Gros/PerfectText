...
const moods = [
  ...
  },
  {
    ...
    placeholder: 'Estoy mirando el móvil como si fuera a pasar algo interesante…'
  },
  {
    emoji: '😌',
  ...
  },
  {
    ...
    placeholder: 'Si alguien quiere empezar, finjo que no esperaba el mensaje 😌'
  }
];
...
export const CreateFeel: React.FC<CreateFeelProps> = ({ name, avatar, onPost }) => {
  ...
  const currentPlaceholder = selectedMood.placeholder || "¿Cómo te sientes hoy en clase?";
