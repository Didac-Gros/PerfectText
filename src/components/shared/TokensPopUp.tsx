...
interface RegisterInputProps {
    onClose: () => void;
    onUpdatePlan: () => void;
    userExpirationDate: Timestamp
}

export function TokensPopUp({ onClose, onUpdatePlan, userExpirationDate }: RegisterInputProps) {
    return (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
            <div className="bg-white rounded-xl p-8 shadow-2xl w-96 relative">
                ...
                <p className="text-gray-600 mb-6 text-center">
                    No tienes tokens suficientes para realizar esta acción.<br />
                    Actualiza tu plan o espera hasta {userExpirationDate.toDate().toLocaleDateString()}.
                </p>
                <button
