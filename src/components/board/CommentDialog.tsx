            ...
            >
              ...
              <div className="flex items-center justify-between px-6 py-4 
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 rounded-xl bg-primary-50 dark:bg-primary-900/20 
              ...
              {/* Comments List */}
              <div className="flex-1 px-6 py-4 overflow-y-auto space-y-6 max-h-[60vh]
                           scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600">
                {comments.length === 0 ? (
                  <div className="flex flex-col items-center justify-center h-full text-center py-12">
                    <div className="w-16 h-16 mb-4 rounded-full bg-gray-100 dark:bg-gray-700 
                                 flex items-center justify-center">
